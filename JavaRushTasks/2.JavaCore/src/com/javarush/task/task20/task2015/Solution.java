...
Требования:
1. Класс SolutionMy должен поддерживать интерфейс Serializable.
2. Класс SolutionMy должен поддерживать интерфейс Runnable.
3. Поле runner в классе SolutionMy должно быть объявлено с модификатором transient.
