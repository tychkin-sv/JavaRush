        ...
        public void run() {
            ...
            /*try {
                do {
                    ...
                    Thread.sleep(1000 / rating);
                    if (OnlineGame.isWinnerFound) break;
                    System.out.println("["+Thread.currentThread().getName() + ":" + OnlineGame.steps.get(currentStep)+"]");

                    currentStep++;
                } while (currentStep<OnlineGame.steps.size());

                if (!OnlineGame.isWinnerFound) {
                    System.out.println(""+Thread.currentThread().getName() + ":победитель!");
                    OnlineGame.isWinnerFound = true;
                } else System.out.println(""+Thread.currentThread().getName() + ":проиграл");
