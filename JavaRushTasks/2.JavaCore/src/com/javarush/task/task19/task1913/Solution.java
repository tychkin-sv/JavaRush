...
Требования:
1. Класс SolutionMy должен содержать класс TestString.
2. Класс SolutionMy должен содержать публичное статическое поле testString
...
5. Метод main(String[] args) класса SolutionMy должен создавать поток PrintStream
   (используй PrintStream c параметром конструктора ByteArrayOutputStream).
6. Метод main(String[] args) класса SolutionMy должен подменять и восстанавливать
    поток вывода в консоль объекта System.out.
7. Метод main(String[] args) класса SolutionMy должен вызывать метод printSomething(),
    объекта testString.
8. Метод main(String[] args) класса SolutionMy должен модифицировать строку выведенную
