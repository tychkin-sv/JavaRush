...
public class Solution {
    ...
    /*
      т.к. модификатор иннер класса private, то чтобы вызвать метод getDescription
      из другого внешнего класса,
    ...
    */
    ...
    private class SuperUser {
        ...
        //доступ к этому методу возможен только внутри класса SolutionOr,
    ...
    public static void main(String[] args) {
        ...
        // внутри класса SolutionOr (а сейчас мы внутри) к методу getDescription
        // можно обращаться обоими способами
