...
public class Solution {
   ...
   // public static volatile AtomicInteger countGlobal;

    public static void main(String[] args) throws IOException {
        //read count of strings
        int count = Integer.parseInt(reader.readLine());
        //countGlobal = new AtomicInteger(count);
        ...
        public void run() {
            ...
            try {
                while (!isInterrupted()) {
                    ...
                    //System.out.println("countReadStrings.get() " + countReadStrings.get());
                if (reader.ready()){
                    int count = countReadStrings.get();
                    //System.out.println("count = " + count);
                  // if ( count== countGlobal.get()) break;
                   result.add(reader.readLine());
                   //System.out.println("это я - " + Thread.currentThread().getName());
