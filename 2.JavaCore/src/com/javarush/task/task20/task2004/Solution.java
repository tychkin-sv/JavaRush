...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = new File("2004.txt"); //File.createTempFile("your_file_name", null);
            ...
            System.out.println("loadedObject equals classWithStatic : " + loadedObject.equals(classWithStatic));
